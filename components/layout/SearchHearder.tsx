...
export const SearchHeader = () => {
  return (
    <section className="flex items-center justify-between w-full px-6 py-3 border-b border-gray-200 bg-white shadow-sm">
      {/* Logo on far left */}
      ...
      {/* Search bar section */}
      <div className="flex p-4 items-center rounded-full shadow-sm hover:shadow-md transition-all duration-200">
        {/* Location input */}
